...
namespace DBFirst
{
    ...
    public partial class NeoDbContext : DbContext
    {
        public NeoDbContext()
            : base("name=NeoDbContext")
        {
        }
        ...
        [DbFunction("NeoDbContext", "GetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> GetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[NeoDbContext].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
